...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      {" "}
      <div className="flex flex-col-reverse md:flex-row gap-10 relative items-start justify-between md:px-36 px-8 md:pt-10 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          ></p>
          {/* course ratings */}
          <div className="flex items-center pt-3 pb-1 space-x-2">
          ...
          <p className="text-sms">
            Course by <span className="text-blue-600 underline">Mehtaab</span>
          </p>
                ...
                >
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-300 ${
                      openSections[index] ? "max-h-960" : "max-h-0"
                    } `}
                  >
        ...
        <div className="z-10 max-w-course-card shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5 ">
            ...
            <div className="flex items-center gap-2 pt-2 md:pt-4">
              <p className="text-gray-800 md:text-4xl font-semibold text-2xl">
                {currency}{" "}
                {(
            ...
            <button className="md:mt-6 cursor-pointer mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium ">
